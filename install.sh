...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/dheonz/v/master/app/rpmforge.rpm
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/dheonz/v/master/app/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/dheonz/v/master/conf/nginx.conf"
...
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/dheonz/v/master/conf/vps.conf"
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/dheonz/v/master/conf/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/dheonz/v/master/conf/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/dheonz/v/master/conf/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/dheonz/v/master/openvpn.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/dheonz/v/master/conf/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/dheonz/v/master/conf/badvpn-udpgw64"
fi
...
# downlaod script
cd /usr/bin
wget -O speedtest "https://raw.githubusercontent.com/dheonz/v/master/speedtest_cli.py"
wget -O bench "https://raw.githubusercontent.com/dheonz/v/master/bench-network.sh"
wget -O mem "https://raw.githubusercontent.com/dheonz/v/master/ps_mem.py"
wget -O userlog "https://raw.githubusercontent.com/dheonz/v/master/login.sh"
wget -O userlogin "https://raw.githubusercontent.com/dheonz/v/master/user-login.sh"
wget -O userexpire "https://raw.githubusercontent.com/dheonz/v/master/autoexpire.sh"
wget -O renew "https://raw.githubusercontent.com/dheonz/v/master/user-renew.sh"
wget -O userlist "https://raw.githubusercontent.com/dheonz/v/master/user-list.sh"
wget -O hapus "https://raw.githubusercontent.com/dheonz/v/master/user-del.sh"
echo "cat log-install.txt" | tee info
echo "python /usr/bin/speedtest.py --share" | tee speedtest
wget -O speedtest "https://raw.githubusercontent.com/dheonz/v/master/speedtest_cli.py"
wget -O user-add "https://raw.githubusercontent.com/dheonz/v/master/uus"
...
wget -O menu "https://raw.githubusercontent.com/dheonz/v/master/mm"
wget -O tls "https://raw.githubusercontent.com/dheonz/v/master/sl.sh"
